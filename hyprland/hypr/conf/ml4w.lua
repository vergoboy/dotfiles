...
-- Use the GTK platform theme so Qt5 (VLC) AND Qt6 apps follow the dark GTK
-- theme. qt6ct is Qt6-only; Qt5 apps like VLC could not load it and fell back
-- to the light Fusion style.
