...
-- Developer & AI shortcuts
hl.bind(mainMod .. " + SHIFT + RETURN", hl.dsp.exec_cmd("~/.config/ml4w/scripts/terminal-cwd.sh"), { description = "Open terminal in current directory" })
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("code"), { description = "Open code editor (VS Code)" })
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("kitty -e opencode"), { description = "Open opencode AI assistant" })
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-ai-scratchpad.sh"), { description = "Toggle AI scratchpad (opencode)" })

-- Power, file browsing & monitoring shortcuts
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("~/.config/hypr/scripts/power-menu.sh"), { description = "Open power menu (u shutdown, r reboot)" })
hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd("kitty -e yazi"), { description = "Open yazi file browser" })
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("kitty -e btop"), { description = "Open system monitor (btop)" })

-- Open the application launcher: SUPER alone did not work, using SUPER + SPACE
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"), { description = "Open application launcher (Super)" })
...
hl.bind(mainMod .. " + SHIFT + O", hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-animations.sh"), { description = "Toggle animations" })
...
hl.bind(mainMod .. " + SHIFT + SPACE", hl.dsp.exec_cmd("qs ipc call statusbar focus"), { description = "Expand statusbar and focus it for keyboard navigation" })
