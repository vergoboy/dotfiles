################################################################################
#  🐟  Fish Shell Config — for Linux / Git / Python / Docker / SSH
...
# Adding common paths to PATH
fish_add_path ~/.local/bin
fish_add_path ~/.cargo/bin
fish_add_path ~/go/bin

# ──────────────────────────────────────────────────────────────────────────────
#  Pretty informative prompt (no external plugin needed)
# ──────────────────────────────────────────────────────────────────────────────
...
# fssh — pick a host from ~/.ssh/config with fzf
function fssh
...
# History search with arrow keys (fish default, but explicit)
bind \e\[A history-search-backward
bind \e\[B history-search-forward

# Enable Ctrl+R history completion if fzf is installed
if command -sq fzf
    fzf --fish | source
end
...
# ──────────────────────────────────────────────────────────────────────────────
#  Animated planet splash + fastfetch on terminal open
#  (Remove this block to disable. Wrapper: ~/.config/fastfetch/anim/fastfetch.sh)
# ──────────────────────────────────────────────────────────────────────────────
